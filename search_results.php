...
WHERE (products.product_name LIKE '%$search%')");
      ...
      $filter=$connect->query("SELECT products.*, category.type_name
FROM products INNER JOIN category ON (products.category_id = category.type_id)
WHERE (category.type_name ='$category' AND products.product_name LIKE '%$search%') ");
  }
            ...
            <div class="product-grid-area">
              <ul class="products-grid">
                  ...
                  <div class="product-item">
                    ...
                    echo "<h2>Sorry!!! No search Results found for the products in this category. Keep on checking</h2>";
                  }
